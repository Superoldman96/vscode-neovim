...
## [1.18.7](https://github.com/Superoldman96/vscode-neovim/compare/v1.19.3...v1.18.7) (2026-09-14)


### ⚠ BREAKING CHANGES

* use VSCode log level instead of our own ([#1962](https://github.com/Superoldman96/vscode-neovim/issues/1962))
* The old composite commands are removed.
* vscode.get_status_item has been removed.
* **bindings:** enable bindings through configuration ([#1558](https://github.com/Superoldman96/vscode-neovim/issues/1558))
* lua API ([#1532](https://github.com/Superoldman96/vscode-neovim/issues/1532))

### chore

* release 0.9.1 ([11e7705](https://github.com/Superoldman96/vscode-neovim/commit/11e77056d6d19af810b24401efa4d5ef16fc19f1))
* release 1.0.0 ([0aa53fe](https://github.com/Superoldman96/vscode-neovim/commit/0aa53fe92c28cf737f09b91940c58bdacf7206df))
* release 1.10.0 ([95d3ca4](https://github.com/Superoldman96/vscode-neovim/commit/95d3ca429febab9531551e222bf30ef0dc3ee74f))
* release 1.11.0 ([dc8d622](https://github.com/Superoldman96/vscode-neovim/commit/dc8d6224bb42d9889854c9f69277bfeb35d399a5))
* release 1.11.4 ([3137516](https://github.com/Superoldman96/vscode-neovim/commit/3137516c221a40f83b67c703137aad84f76868a7))
* release 1.18.1 ([8500b65](https://github.com/Superoldman96/vscode-neovim/commit/8500b65636c7e916d07301de90fa4131bfadfe46))
* release 1.18.7 ([9b64ffb](https://github.com/Superoldman96/vscode-neovim/commit/9b64ffb37dd11edc98b4f85848a0c3624e82a825))


### Features

* `vscode.eval()` ([#1854](https://github.com/Superoldman96/vscode-neovim/issues/1854)) ([32eedf0](https://github.com/Superoldman96/vscode-neovim/commit/32eedf08fa7bce669666492b6515091352913ae4))
* add action `start-multiple-cursors` ([#1547](https://github.com/Superoldman96/vscode-neovim/issues/1547)) ([f4a6ac5](https://github.com/Superoldman96/vscode-neovim/commit/f4a6ac5bc2fd942a76402f27e3bb88df2924bba4))
* Add clipboard provider `g:vscode_clipboard` ([#1688](https://github.com/Superoldman96/vscode-neovim/issues/1688)) ([c5346c8](https://github.com/Superoldman96/vscode-neovim/commit/c5346c8c185840655291bd0b50daecf36b00285d))
* Add command "vscode-neovim.lua" ([#1622](https://github.com/Superoldman96/vscode-neovim/issues/1622)) ([980f40a](https://github.com/Superoldman96/vscode-neovim/commit/980f40a22aea5c20f2639c7e4ada5c5bcc107d44))
* Add option `afterInitConfig` ([#1695](https://github.com/Superoldman96/vscode-neovim/issues/1695)) ([ec2b287](https://github.com/Superoldman96/vscode-neovim/commit/ec2b287f891ae34935a1d4fff5602ae1fcbfd687))
* Add progress indicator for layout sync ([#2137](https://github.com/Superoldman96/vscode-neovim/issues/2137)) ([81bcdab](https://github.com/Superoldman96/vscode-neovim/commit/81bcdabff59784fc5fb8de0ddbea648fbb305139))
* Add statusLineItems config option ([#2560](https://github.com/Superoldman96/vscode-neovim/issues/2560)) ([6a356a4](https://github.com/Superoldman96/vscode-neovim/commit/6a356a465770cba9d9b67deaceb38b6b19f3aee2))
* Add vscode commands "restart" and "stop" ([#1566](https://github.com/Superoldman96/vscode-neovim/issues/1566)) ([f2f57f8](https://github.com/Superoldman96/vscode-neovim/commit/f2f57f82f1b9d7b16f52fd7977b7fb3d1e447280))
* Allow specifying WSL distro by wslDistribution ([#1693](https://github.com/Superoldman96/vscode-neovim/issues/1693)) ([6c5dbcb](https://github.com/Superoldman96/vscode-neovim/commit/6c5dbcb68a00ae2df29e61bdf91f9bf15987564d))
* **api:** add `vscode.get_status_item` ([#1576](https://github.com/Superoldman96/vscode-neovim/issues/1576)) ([c20ce2f](https://github.com/Superoldman96/vscode-neovim/commit/c20ce2fba5e07feeeac333a00be3dbf7575ed465))
* **api:** add `vscode.to_op` and refactor code actions ([#1570](https://github.com/Superoldman96/vscode-neovim/issues/1570)) ([c9d600f](https://github.com/Superoldman96/vscode-neovim/commit/c9d600f27de328d37d2d810f355ef6a0fdd2d1fc))
* **api:** support passing a map-like table as args ([#1670](https://github.com/Superoldman96/vscode-neovim/issues/1670)) ([8fe3d8f](https://github.com/Superoldman96/vscode-neovim/commit/8fe3d8f9d37ef5f980954c9e1eddbed882ee62ef))
* **api:** vscode settings integration ([80f10d2](https://github.com/Superoldman96/vscode-neovim/commit/80f10d299a1858dd272bb0f9642c414188cfa1a0))
* Auto find a suitable neovim executable ([#1894](https://github.com/Superoldman96/vscode-neovim/issues/1894)) ([a0f5c25](https://github.com/Superoldman96/vscode-neovim/commit/a0f5c253e3ce647f15040d063ec83cb31aa6acdc))
* better composite key support ([#1917](https://github.com/Superoldman96/vscode-neovim/issues/1917)) ([44808b3](https://github.com/Superoldman96/vscode-neovim/commit/44808b399a17aa1c59f64313773c6ea7b5fe2385))
* **bindings:** enable bindings through configuration ([#1558](https://github.com/Superoldman96/vscode-neovim/issues/1558)) ([222a131](https://github.com/Superoldman96/vscode-neovim/commit/222a131150745fc99c624b1f9eece9a91341df1a))
* **bindings:** handle C-d/C-u in hover widget ([#1744](https://github.com/Superoldman96/vscode-neovim/issues/1744)) ([64c4cc7](https://github.com/Superoldman96/vscode-neovim/commit/64c4cc7bb56a64aa8627b1a8bab9bee0446ea17c))
* **buffer:** sync dirty buffer state ([#2127](https://github.com/Superoldman96/vscode-neovim/issues/2127)) ([61f4e4f](https://github.com/Superoldman96/vscode-neovim/commit/61f4e4f842d7a7a559b60e7e82f3acb26c908abb))
* **cmdline:** integrate with native neovim completions ([#2001](https://github.com/Superoldman96/vscode-neovim/issues/2001)) ([9ed0be0](https://github.com/Superoldman96/vscode-neovim/commit/9ed0be0b0901d36509b79e1eab57aba136dbc722))
* ctrl+n/ctrl+p for selecting rename suggestions ([#2093](https://github.com/Superoldman96/vscode-neovim/issues/2093)) ([bbf5df3](https://github.com/Superoldman96/vscode-neovim/commit/bbf5df3436db1cf47337933410c0b7d20aa22b0c))
* **dev:** pre-commit hooks ([#1853](https://github.com/Superoldman96/vscode-neovim/issues/1853)) ([e2a36d8](https://github.com/Superoldman96/vscode-neovim/commit/e2a36d872e23fd8e623d67dd9ccf5aa1e51d2f09))
* expose logs in OutputChannel, log info on startup [#1786](https://github.com/Superoldman96/vscode-neovim/issues/1786) ([f77256b](https://github.com/Superoldman96/vscode-neovim/commit/f77256be6afcaa596dc8c3cb9d4e6bc0cb12cfab))
* handle nvim statusline ([#1895](https://github.com/Superoldman96/vscode-neovim/issues/1895)) ([fa5fc14](https://github.com/Superoldman96/vscode-neovim/commit/fa5fc14389a0a5c5d97ec35458b826d052181a24))
* **highlight:** draw grid lines accurately ([#2090](https://github.com/Superoldman96/vscode-neovim/issues/2090)) ([50a7d5c](https://github.com/Superoldman96/vscode-neovim/commit/50a7d5cc50b085beaffa156ccc4873c00d764569))
* Integrate BufWriteCmd for "write" command ([#2116](https://github.com/Superoldman96/vscode-neovim/issues/2116)) ([8606eb1](https://github.com/Superoldman96/vscode-neovim/commit/8606eb183a420223c0fc102639b8b3ad753cfecb))
* Introduce `vscode-multi-cursor.nvim` ([#1553](https://github.com/Superoldman96/vscode-neovim/issues/1553)) ([2657c45](https://github.com/Superoldman96/vscode-neovim/commit/2657c4506b3dffe0d069db2891e30cebd963c2be))
* **keybindings:** add keybindings for output panel ([#1685](https://github.com/Superoldman96/vscode-neovim/issues/1685)) ([12502e0](https://github.com/Superoldman96/vscode-neovim/commit/12502e0a3d20cc8f0d21be7f121b34ce6c8bc815))
* **keybindings:** Add keybindings for the hover widget ([#1694](https://github.com/Superoldman96/vscode-neovim/issues/1694)) ([68f0df8](https://github.com/Superoldman96/vscode-neovim/commit/68f0df895bd9a08a35c692432de76e2c8cf4f1ee))
* **keybindings:** global window resize/split ([#1257](https://github.com/Superoldman96/vscode-neovim/issues/1257)) ([9cb8aff](https://github.com/Superoldman96/vscode-neovim/commit/9cb8aff9de313d157a22f5f1a6e7409582bd9757))
* **logging:** check that $VIMRUNTIME is readable [#1816](https://github.com/Superoldman96/vscode-neovim/issues/1816) ([c9ddc3e](https://github.com/Superoldman96/vscode-neovim/commit/c9ddc3ea90444e17b325c1b2c0c6756ad8d8374d)), closes [#1815](https://github.com/Superoldman96/vscode-neovim/issues/1815)
* **logging:** log Nvim info at startup ([#1797](https://github.com/Superoldman96/vscode-neovim/issues/1797)) ([6b174c8](https://github.com/Superoldman96/vscode-neovim/commit/6b174c81d4327186d350643a4867f7155693d18a))
* lua API ([#1532](https://github.com/Superoldman96/vscode-neovim/issues/1532)) ([80f10d2](https://github.com/Superoldman96/vscode-neovim/commit/80f10d299a1858dd272bb0f9642c414188cfa1a0))
* **lua:** Add "vscode.with_insert" ([#2055](https://github.com/Superoldman96/vscode-neovim/issues/2055)) ([be8812f](https://github.com/Superoldman96/vscode-neovim/commit/be8812f7fbdc20917e18d844507001f2b347a07e))
* move output messages to a separate channel ([#2022](https://github.com/Superoldman96/vscode-neovim/issues/2022)) ([39e1ae2](https://github.com/Superoldman96/vscode-neovim/commit/39e1ae2c780289e77abd0eb207c80a61f7e5f6c4))
* override the default vim.ui interfaces ([#1710](https://github.com/Superoldman96/vscode-neovim/issues/1710)) ([b522787](https://github.com/Superoldman96/vscode-neovim/commit/b52278772a6b3557d8b05471b1fb90a2375f662a))
* override vim.lsp.buf methods ([#2045](https://github.com/Superoldman96/vscode-neovim/issues/2045)) ([f7fbce1](https://github.com/Superoldman96/vscode-neovim/commit/f7fbce1010090377f6050cc94e4a331a1eaaf9ca))
* R to refresh file explorer ([5464b48](https://github.com/Superoldman96/vscode-neovim/commit/5464b48b4d4e6979dd0c2a61cdb76d2ffb06739f))
* refactor `==` and `gc`, support motions and dotrepeat ([c9d600f](https://github.com/Superoldman96/vscode-neovim/commit/c9d600f27de328d37d2d810f355ef6a0fdd2d1fc))
* revamp messages output channel ([#2024](https://github.com/Superoldman96/vscode-neovim/issues/2024)) ([0957121](https://github.com/Superoldman96/vscode-neovim/commit/09571212c176225ea3eca4f351296ed464b804b5))
* show output when return_prompt is sent ([#2029](https://github.com/Superoldman96/vscode-neovim/issues/2029)) ([625397e](https://github.com/Superoldman96/vscode-neovim/commit/625397efef2913321f090c93fb43ecb791182234))
* **startup:** improve find-Nvim logic + failure handling [#2679](https://github.com/Superoldman96/vscode-neovim/issues/2679) ([0cd2460](https://github.com/Superoldman96/vscode-neovim/commit/0cd2460ab391ae9e154deed55fcf62c9dffd63ed))
* Support inccommand, including "split" ([c01e149](https://github.com/Superoldman96/vscode-neovim/commit/c01e1496e1ec5a46872297cabb3ed0a46ecc6f1c))
* synchronize editor options and support `modeline` ([#1543](https://github.com/Superoldman96/vscode-neovim/issues/1543)) ([a08c17d](https://github.com/Superoldman96/vscode-neovim/commit/a08c17d1fb246101afa44077305fd5a15d4ba7e6))
* trigger FocusGained/Lost by default (80f10d29) ([5a4a36c](https://github.com/Superoldman96/vscode-neovim/commit/5a4a36c434e9e2c6d6476c9d45a29c4f26adc8c5))
* triggering FocusGained/Lost by default ([80f10d2](https://github.com/Superoldman96/vscode-neovim/commit/80f10d299a1858dd272bb0f9642c414188cfa1a0))
* use VSCode log level instead of our own ([#1962](https://github.com/Superoldman96/vscode-neovim/issues/1962)) ([5f1bc49](https://github.com/Superoldman96/vscode-neovim/commit/5f1bc495c2499f97448752489e1e1b2f5d466b9a))


### Bug Fixes

* "Right-hand side of 'instanceof' is not an object" [#2672](https://github.com/Superoldman96/vscode-neovim/issues/2672) ([97586d2](https://github.com/Superoldman96/vscode-neovim/commit/97586d2599b9ef38ad9c5be37802991c83717665))
* [#1531](https://github.com/Superoldman96/vscode-neovim/issues/1531) ([deb41d4](https://github.com/Superoldman96/vscode-neovim/commit/deb41d463de8d04453f1ca5e2b8acf6393e7464a))
* account for level when handling cmdline_hide events ([#2034](https://github.com/Superoldman96/vscode-neovim/issues/2034)) ([8760f81](https://github.com/Superoldman96/vscode-neovim/commit/8760f81fd82d5daf3db70712cd379cd1356a0d18))
* adapt to Nvim deprecations in 0.10 ([#2108](https://github.com/Superoldman96/vscode-neovim/issues/2108)) ([4c04ebc](https://github.com/Superoldman96/vscode-neovim/commit/4c04ebc399e7cdf44476247da0b58430ed025c70))
* add optional delay parameter to with_insert callback ([#2479](https://github.com/Superoldman96/vscode-neovim/issues/2479)) ([ae4d02c](https://github.com/Superoldman96/vscode-neovim/commit/ae4d02c047bdba9aab7907176b60c7b2ec8b0d0a))
* add the missing "local" in "vscode.notify" ([2d8230c](https://github.com/Superoldman96/vscode-neovim/commit/2d8230cc41cfe9ce23a1a56105182c4b98629a87))
* Align output with nvim messages and auto show based on cmdheight ([#2105](https://github.com/Superoldman96/vscode-neovim/issues/2105)) ([4ca8fbf](https://github.com/Superoldman96/vscode-neovim/commit/4ca8fbf70edfaaf080823d583e8d2105ace0c06e))
* **api:** add delay for cursor synchronization in with_insert ([#2415](https://github.com/Superoldman96/vscode-neovim/issues/2415)) ([15191dd](https://github.com/Superoldman96/vscode-neovim/commit/15191dd161615c1f2f2aa6a0b737ddeb7d70ae06))
* **api:** fix `VSCodeCall` ([35ec974](https://github.com/Superoldman96/vscode-neovim/commit/35ec9743cbb6e6cae998da253da6e4885cc1eb63))
* **api:** update configuration target options to include "workspace_folder" ([#2447](https://github.com/Superoldman96/vscode-neovim/issues/2447)) ([68f68b9](https://github.com/Superoldman96/vscode-neovim/commit/68f68b9562e34a1c72e0ed9478d73bb293e283a0))
* auto stop extension when starting nvim failed ([#1703](https://github.com/Superoldman96/vscode-neovim/issues/1703)) ([67e10ad](https://github.com/Superoldman96/vscode-neovim/commit/67e10ad9db4a26995c39d670cd6478274d0dd5a8))
* avoid disposing uninitialized instances ([5464b48](https://github.com/Superoldman96/vscode-neovim/commit/5464b48b4d4e6979dd0c2a61cdb76d2ffb06739f))
* avoid unnecessary rpcnotify that cause crashs (temporary fix) ([#2179](https://github.com/Superoldman96/vscode-neovim/issues/2179)) ([cc54e2b](https://github.com/Superoldman96/vscode-neovim/commit/cc54e2b0738c495f3ea6eef3ba9dbef6d37d3ec8))
* **bindings:** C-w in cmdline ([#1742](https://github.com/Superoldman96/vscode-neovim/issues/1742)) ([048acea](https://github.com/Superoldman96/vscode-neovim/commit/048acea91676c2216cf418c8bbfafae27f2c4a3a))
* **blockwise-visual:** handle double-width chars and tabs ([#1596](https://github.com/Superoldman96/vscode-neovim/issues/1596)) ([c554c06](https://github.com/Superoldman96/vscode-neovim/commit/c554c065a375f2bd32346aabdb6526ece8bb4189))
* **buffer:** avoid concurrent syncs and stale data ([#2103](https://github.com/Superoldman96/vscode-neovim/issues/2103)) ([59246d6](https://github.com/Superoldman96/vscode-neovim/commit/59246d624f9cdc4ed141006de621f486b5f5586c))
* **buffer:** bufname conflict when creating a new buffer ([#1652](https://github.com/Superoldman96/vscode-neovim/issues/1652)) ([f304335](https://github.com/Superoldman96/vscode-neovim/commit/f304335ce14388fbc47fb577a53f5ced681f0d6a))
* **buffer:** cancel visual mode when switching editor ([#1578](https://github.com/Superoldman96/vscode-neovim/issues/1578)) ([15cb3d7](https://github.com/Superoldman96/vscode-neovim/commit/15cb3d78b13360743a3466ade0de572981ca2203))
* **buffer:** prefer real path as buffer name ([#1699](https://github.com/Superoldman96/vscode-neovim/issues/1699)) ([eff13f2](https://github.com/Superoldman96/vscode-neovim/commit/eff13f2809f7992c48facb895e835ef214478d01))
* **buffers:** async window/buffer cleanup [#2230](https://github.com/Superoldman96/vscode-neovim/issues/2230) ([396a0bc](https://github.com/Superoldman96/vscode-neovim/commit/396a0bc3fb0a37fc6014470f4609808e17920c98))
* **buffers:** Fix saving to files inside symlinked workspaces ([#2302](https://github.com/Superoldman96/vscode-neovim/issues/2302)) ([607b4c7](https://github.com/Superoldman96/vscode-neovim/commit/607b4c7c387384d9a0e565ca4fb00cafe07112a3))
* **buffer:** sync layout on doc closed ([#1706](https://github.com/Superoldman96/vscode-neovim/issues/1706)) ([81951e7](https://github.com/Superoldman96/vscode-neovim/commit/81951e70daebbe4d1448ffec1d02192d69e526ad))
* Cancel UI-affecting tasks upon disposal ([#2161](https://github.com/Superoldman96/vscode-neovim/issues/2161)) ([508d6b3](https://github.com/Superoldman96/vscode-neovim/commit/508d6b3094f06b25ec72a9e39953bf697b88c342))
* Cannot use strwidth to get string length ([#1635](https://github.com/Superoldman96/vscode-neovim/issues/1635)) ([9e0cff5](https://github.com/Superoldman96/vscode-neovim/commit/9e0cff5c6084b13ed99c44079ef9bf7494651d98))
* **change:** Fix bug in setting applyingEdits variable ([8f6447c](https://github.com/Superoldman96/vscode-neovim/commit/8f6447c362b97fa12c3147a897b8714cfa846391))
* **change:** Respect the selections of the editor ([#1661](https://github.com/Superoldman96/vscode-neovim/issues/1661)) ([4b8f242](https://github.com/Superoldman96/vscode-neovim/commit/4b8f2429a95095bd9012a7c4769d172f5a3bc38a))
* **ci:** broken release-please config [#2647](https://github.com/Superoldman96/vscode-neovim/issues/2647) ([ac94663](https://github.com/Superoldman96/vscode-neovim/commit/ac946636d4f2c39569077a914c9793d2ff5f826d))
* **ci:** make husky executable ([b75a7f7](https://github.com/Superoldman96/vscode-neovim/commit/b75a7f7bfbe67d67364e1197f9c9b15932729e33))
* **ci:** set permissions:read ([73004bd](https://github.com/Superoldman96/vscode-neovim/commit/73004bda882757f4e844e707af2e7a6a7765da21))
* **ci:** set permissions:read ([4f261e7](https://github.com/Superoldman96/vscode-neovim/commit/4f261e7eba9e407af8ba57482396a5256e166e4e))
* **cmdline:** allow enter to accept cmdline after completion selected ([#2007](https://github.com/Superoldman96/vscode-neovim/issues/2007)) ([d09891f](https://github.com/Superoldman96/vscode-neovim/commit/d09891ff80c1088c5f8ab510a392ae682fc04bb1))
* **cmdline:** handle `wildmenu_hide` event ([#1541](https://github.com/Superoldman96/vscode-neovim/issues/1541)) ([1b68475](https://github.com/Superoldman96/vscode-neovim/commit/1b68475f190a80a74dee26ef37fc692d1a66c79a))
* **cmdline:** handle async input hide race condition ([#2531](https://github.com/Superoldman96/vscode-neovim/issues/2531)) ([19b7181](https://github.com/Superoldman96/vscode-neovim/commit/19b718135fe9c5d7844ebd28a83e8508e85332eb))
* **cmdline:** use Ctrl+n/p to select candidates when candidates exist ([1b68475](https://github.com/Superoldman96/vscode-neovim/commit/1b68475f190a80a74dee26ef37fc692d1a66c79a))
* correctly dispose the output channels ([#2033](https://github.com/Superoldman96/vscode-neovim/issues/2033)) ([dde1b79](https://github.com/Superoldman96/vscode-neovim/commit/dde1b798db9f9e1639dcc7e316be388949ac7563))
* Correctly set doc version for skipping changes ([#2037](https://github.com/Superoldman96/vscode-neovim/issues/2037)) ([9e95dbe](https://github.com/Superoldman96/vscode-neovim/commit/9e95dbe36cb3fac4c172cc35edbf46cc69dd8922))
* cursor position after scrolling with incsearch ([5fedba5](https://github.com/Superoldman96/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* **cursor:** always reveal the nvim cursor position ([#1911](https://github.com/Superoldman96/vscode-neovim/issues/1911)) ([37f3434](https://github.com/Superoldman96/vscode-neovim/commit/37f343455425c2f6a758f31eb09f644697683e9a))
* **cursor:** compare active position, not selection ([#2213](https://github.com/Superoldman96/vscode-neovim/issues/2213)) ([e9d6584](https://github.com/Superoldman96/vscode-neovim/commit/e9d6584f324e6a5725305c27610dcbf722b1e9f8))
* **cursor:** Current character not correctly obtained ([ed4e988](https://github.com/Superoldman96/vscode-neovim/commit/ed4e988c5715973d58b0e68f4c8ce6f37f389383))
* **cursor:** ignore cursor position errors in the output ([#1568](https://github.com/Superoldman96/vscode-neovim/issues/1568)) ([08ef9d3](https://github.com/Superoldman96/vscode-neovim/commit/08ef9d39f0b4cac79da2fadad380bb323088c007))
* **defaults:** keybindings for ctrl+[BracketLeft], ctrl+[BracketRight] as alternatives for ctrl+[ and ctrl+]. ([#2390](https://github.com/Superoldman96/vscode-neovim/issues/2390)) ([cdbead6](https://github.com/Superoldman96/vscode-neovim/commit/cdbead63951da0af72b5cd9e9e77a8697944ae42))
* detect potential module conflicts ([#2041](https://github.com/Superoldman96/vscode-neovim/issues/2041)) ([04c6fc2](https://github.com/Superoldman96/vscode-neovim/commit/04c6fc29269a636bd752230f8f59b132dc1efd29))
* do not open the file automatically after writing ([#2416](https://github.com/Superoldman96/vscode-neovim/issues/2416)) ([2564492](https://github.com/Superoldman96/vscode-neovim/commit/2564492ca5e0ba65e89602abee6e0d77fa3f43be))
* **document_change:** eol is inconsistent when processing changes ([#1619](https://github.com/Superoldman96/vscode-neovim/issues/1619)) ([6d870f9](https://github.com/Superoldman96/vscode-neovim/commit/6d870f99cf15658d23d1fe1b003a555f56d7e5ad))
* don't show output panel after return_prompt, reverts [#2029](https://github.com/Superoldman96/vscode-neovim/issues/2029) ([#2061](https://github.com/Superoldman96/vscode-neovim/issues/2061)) ([6250a1d](https://github.com/Superoldman96/vscode-neovim/commit/6250a1d00cea0fef7913c00b85176211ba7bc926))
* **dotrepeat:** incorrect order of deletion and addition ([#1581](https://github.com/Superoldman96/vscode-neovim/issues/1581)) ([5385c25](https://github.com/Superoldman96/vscode-neovim/commit/5385c25d0c9462f3a679a5bb21c21936ce9da091))
* **dotrepeat:** replay clobbers the insert session ([87ddfb9](https://github.com/Superoldman96/vscode-neovim/commit/87ddfb983cfa793e1b0e71f616513f658839884c))
* **dotrepeat:** should escape K_SPECIAL bytes ([68557f7](https://github.com/Superoldman96/vscode-neovim/commit/68557f798d9bbc2225db9b8ab45b90664bcddf36))
* ensure statusline messages are shown for a minimum amount of time before clears are effective ([#2068](https://github.com/Superoldman96/vscode-neovim/issues/2068)) ([a8064e3](https://github.com/Superoldman96/vscode-neovim/commit/a8064e3a6c1b3e4fd5c97fae7f0061c26bde6fe0))
* **eval:** try serializing the object result ([#1966](https://github.com/Superoldman96/vscode-neovim/issues/1966)) ([b387d29](https://github.com/Superoldman96/vscode-neovim/commit/b387d29568ca7976851fa7a1b485e204b7d34b08))
* exit visual mode on mouse click or selection cancel ([#2300](https://github.com/Superoldman96/vscode-neovim/issues/2300)) ([fe35981](https://github.com/Superoldman96/vscode-neovim/commit/fe3598163d468b5daac76299c3f796cfdeeb5d29))
* fallback statusline to empty ([#2518](https://github.com/Superoldman96/vscode-neovim/issues/2518)) ([ec20106](https://github.com/Superoldman96/vscode-neovim/commit/ec20106a05b24d1c294cafad86c92909ac0256c9))
* Fix assertContent cursor position parameter ([fe35981](https://github.com/Superoldman96/vscode-neovim/commit/fe3598163d468b5daac76299c3f796cfdeeb5d29))
* fix command `vscode-neovim.stop` ([c8809ed](https://github.com/Superoldman96/vscode-neovim/commit/c8809ed4c7591a75c960209c810120ddfa449f01))
* Fix forcing sync editor selections ([#1674](https://github.com/Superoldman96/vscode-neovim/issues/1674)) ([7ebc1b2](https://github.com/Superoldman96/vscode-neovim/commit/7ebc1b26384eee1a82a9449e238d60741a26d5e5))
* Fix multi-byte character selection in Nvim 0.10 blockwise visual ([#2169](https://github.com/Superoldman96/vscode-neovim/issues/2169)) ([2f68d87](https://github.com/Superoldman96/vscode-neovim/commit/2f68d87e44f65e114e4061917ff2abbaac0e99de))
* fix setting client info in wsl ([#1687](https://github.com/Superoldman96/vscode-neovim/issues/1687)) ([11e3cab](https://github.com/Superoldman96/vscode-neovim/commit/11e3cab75b64c0075a96c1c6558061e5d568882f))
* Fix setting the cwd in remote development ([#2062](https://github.com/Superoldman96/vscode-neovim/issues/2062)) ([62bab05](https://github.com/Superoldman96/vscode-neovim/commit/62bab0597590ba4445b57b98653b2f0dd60ee002))
* fix sourcing our runtime files ([#1679](https://github.com/Superoldman96/vscode-neovim/issues/1679)) ([567fea5](https://github.com/Superoldman96/vscode-neovim/commit/567fea5674a24673ea2e48db528571b9ace72946))
* force `winborder` to `none` ([#2444](https://github.com/Superoldman96/vscode-neovim/issues/2444)) ([4a444b4](https://github.com/Superoldman96/vscode-neovim/commit/4a444b4c60dc3dd6381fa66d3e6ebccca618d15b))
* handle `topline` in the `viewport-changed` event ([#2197](https://github.com/Superoldman96/vscode-neovim/issues/2197)) ([c7145f2](https://github.com/Superoldman96/vscode-neovim/commit/c7145f2ef8079168b80a20a04ef9022ed06924dc))
* handle Neovim buffer sync compatibility ([a952bb1](https://github.com/Superoldman96/vscode-neovim/commit/a952bb191a4ccbe508fd737ca2299d256d41c5ad))
* handle timeout in eval properly ([#1863](https://github.com/Superoldman96/vscode-neovim/issues/1863)) ([767f7ca](https://github.com/Superoldman96/vscode-neovim/commit/767f7ca6a3c338b662edacabe833614cf7ea0221))
* handle topline in the viewport-changed event ([c7145f2](https://github.com/Superoldman96/vscode-neovim/commit/c7145f2ef8079168b80a20a04ef9022ed06924dc))
* hide internal commands from command palette [#2668](https://github.com/Superoldman96/vscode-neovim/issues/2668) ([d1c38f5](https://github.com/Superoldman96/vscode-neovim/commit/d1c38f5eb8e41e5b8ceac9446521cbc76708b070))
* highlight calculations race with buffer updates ([#1890](https://github.com/Superoldman96/vscode-neovim/issues/1890)) ([53acfe5](https://github.com/Superoldman96/vscode-neovim/commit/53acfe564012b9b1a20563d665791a8f28f810d5))
* **highlight:** Do not clear custom highlight groups directly ([#1633](https://github.com/Superoldman96/vscode-neovim/issues/1633)) ([f5381a7](https://github.com/Superoldman96/vscode-neovim/commit/f5381a726ebb40c679d4c410659a11dc93d6b7da))
* **highlight:** do not widen the decoration's range ([deb41d4](https://github.com/Superoldman96/vscode-neovim/commit/deb41d463de8d04453f1ca5e2b8acf6393e7464a)), closes [#1531](https://github.com/Superoldman96/vscode-neovim/issues/1531)
* **highlight:** Fix pattern matching of syntax groups ([#2150](https://github.com/Superoldman96/vscode-neovim/issues/2150)) ([78dc156](https://github.com/Superoldman96/vscode-neovim/commit/78dc156c453c9e6457c81092c24be7d14b54e0be))
* **highlight:** forward search / matching in long lines ([#1976](https://github.com/Superoldman96/vscode-neovim/issues/1976)) ([5fedba5](https://github.com/Superoldman96/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* **highlight:** Identify custom highlight group correctly ([#1628](https://github.com/Superoldman96/vscode-neovim/issues/1628)) ([da15b14](https://github.com/Superoldman96/vscode-neovim/commit/da15b1474dc19058e8b5037592b345ad3b6c54a4))
* **highlight:** leading dashes could be combined with statuscolumn ([#2187](https://github.com/Superoldman96/vscode-neovim/issues/2187)) ([9eb7eed](https://github.com/Superoldman96/vscode-neovim/commit/9eb7eed232d6f849106951fc7ee44521bf051f32))
* **highlight:** make `borderColor` work ([#1557](https://github.com/Superoldman96/vscode-neovim/issues/1557)) ([398d0fe](https://github.com/Superoldman96/vscode-neovim/commit/398d0fed517211bf7335b9042ac39f8a015257f1))
* **highlight:** remove duplicate visual selection highlight ([#1643](https://github.com/Superoldman96/vscode-neovim/issues/1643)) ([d02dbde](https://github.com/Superoldman96/vscode-neovim/commit/d02dbde5832a3f5ac10249b2d3c40e778412166a))
* **highlight:** rendering all cells ([84344a5](https://github.com/Superoldman96/vscode-neovim/commit/84344a5191156f95a357de627a778c406eb9cf81))
* **highlights:** wait for doc changes before updating highlights ([#2112](https://github.com/Superoldman96/vscode-neovim/issues/2112)) ([0835225](https://github.com/Superoldman96/vscode-neovim/commit/083522555ad3d269b83da3885cb18f0982a396be))
* **highlight:** timely win hl ns setup, disable treesitter highlighting ([#1898](https://github.com/Superoldman96/vscode-neovim/issues/1898)) ([eff4e20](https://github.com/Superoldman96/vscode-neovim/commit/eff4e20010531278894bd30eb663ea12bd43f6a7))
* ignore editors without `ViewColumn` in nvim-0.10 ([#2470](https://github.com/Superoldman96/vscode-neovim/issues/2470)) ([b7a9faf](https://github.com/Superoldman96/vscode-neovim/commit/b7a9faf75b5bffde6a9f01de56411ad7c349e11f))
* improve callAtomic error logging ([#1110](https://github.com/Superoldman96/vscode-neovim/issues/1110)) ([91c0169](https://github.com/Superoldman96/vscode-neovim/commit/91c01694be17e28af60530781762c311a378a792))
* improve window change handling with cancellation support ([#2417](https://github.com/Superoldman96/vscode-neovim/issues/2417)) ([0520846](https://github.com/Superoldman96/vscode-neovim/commit/0520846ad9c583f89648020261323d0845cbb3cf))
* include time and scope in log file ([#1951](https://github.com/Superoldman96/vscode-neovim/issues/1951)) ([cccdf99](https://github.com/Superoldman96/vscode-neovim/commit/cccdf9936c03a091e39811d55876c4dfab0dc7fb))
* **incsearch:** viewport is not updating during searching ([#1575](https://github.com/Superoldman96/vscode-neovim/issues/1575)) ([b8696a3](https://github.com/Superoldman96/vscode-neovim/commit/b8696a396c5ddffd0848f30a2c785aa05c2ca79a))
* **incsearch:** win cursor not properly revealed ([#1971](https://github.com/Superoldman96/vscode-neovim/issues/1971)) ([116abdd](https://github.com/Superoldman96/vscode-neovim/commit/116abddcb70a2daccf6fd9e29b51b08724c3141c))
* integration tests ([20a1f6c](https://github.com/Superoldman96/vscode-neovim/commit/20a1f6c18c4e3e089ea7534bb397b6f8df8d58ad))
* **keybinding:** fix `Ctrl+c` ([#1569](https://github.com/Superoldman96/vscode-neovim/issues/1569)) ([4765026](https://github.com/Superoldman96/vscode-neovim/commit/476502604a5fcfef89c528532de17b391036aed6))
* **keybindings:** fix ctrl+w in terminal ([#1297](https://github.com/Superoldman96/vscode-neovim/issues/1297)) ([dc075aa](https://github.com/Superoldman96/vscode-neovim/commit/dc075aaf7177a42c287230d79a09f3de292a7f8e))
* **keybinds:** Ctrl+n and Ctrl+p in cmdline ([#1533](https://github.com/Superoldman96/vscode-neovim/issues/1533)) ([305bc1a](https://github.com/Superoldman96/vscode-neovim/commit/305bc1aae7e444ee67ba5d5fe6438c9cda36f99f))
* **keybinds:** fix behavior of CTRL-m and CTRL-j ([#1886](https://github.com/Superoldman96/vscode-neovim/issues/1886)) ([afb435d](https://github.com/Superoldman96/vscode-neovim/commit/afb435df67189752d7e339d05ed42e57d622cd65))
* **keymap:** scope list fold keybindings to listFocus [#2626](https://github.com/Superoldman96/vscode-neovim/issues/2626) ([f8141d0](https://github.com/Superoldman96/vscode-neovim/commit/f8141d02a76a6073d703e55dfea4aa8c59cd42a3))
* **logging:** infinite loop in BufferManager ([#1790](https://github.com/Superoldman96/vscode-neovim/issues/1790)) ([b011631](https://github.com/Superoldman96/vscode-neovim/commit/b0116315a018db9a8bb7a1d5df4a8f505dfa73f2)), closes [#1788](https://github.com/Superoldman96/vscode-neovim/issues/1788)
* **lua:** avoid naming conflicts from stale hidden buffers ([3f462e3](https://github.com/Superoldman96/vscode-neovim/commit/3f462e3d2133d46fb4c24c8dca0f31b1275364a9))
* maintain the order of positions for the Selection ([#1550](https://github.com/Superoldman96/vscode-neovim/issues/1550)) ([8d76d51](https://github.com/Superoldman96/vscode-neovim/commit/8d76d51cd6952c30ed5858587e64a97ab44c5da8))
* make statusline empty by default ([#2520](https://github.com/Superoldman96/vscode-neovim/issues/2520)) ([c5ad5df](https://github.com/Superoldman96/vscode-neovim/commit/c5ad5df4c50d82c7839aad38e88903b7d5f046b7))
* manually set languageId to buffer filetype for special documents ([#2174](https://github.com/Superoldman96/vscode-neovim/issues/2174)) ([fad8034](https://github.com/Superoldman96/vscode-neovim/commit/fad803423adb2ea174cd4a60a100d475c7a260ed))
* Match any ASCII characters in composite keys ([#1923](https://github.com/Superoldman96/vscode-neovim/issues/1923)) ([51e2f11](https://github.com/Superoldman96/vscode-neovim/commit/51e2f11c474ed7b1f9c2817f6e498805abca4ae2))
* **messages:** Limit the minimum value of `cmdheight` to 1 ([#2110](https://github.com/Superoldman96/vscode-neovim/issues/2110)) ([1e29f60](https://github.com/Superoldman96/vscode-neovim/commit/1e29f604487b66f2cb682c1f24e65ac1e97def20))
* **messages:** output panel misses multi-flush messages [#2629](https://github.com/Superoldman96/vscode-neovim/issues/2629) ([f2cfb7e](https://github.com/Superoldman96/vscode-neovim/commit/f2cfb7e7b98729bbbfb123deb8eb4572d81b403d))
* only fallback BufModifiedSet autocmd on unsupported event ([7e561f7](https://github.com/Superoldman96/vscode-neovim/commit/7e561f7803536dc2b63bdbe17f3fce86dd359ef3))
* preserve visual line/block mode when scrolling with C-d/C-u [#2617](https://github.com/Superoldman96/vscode-neovim/issues/2617) ([f62ee6a](https://github.com/Superoldman96/vscode-neovim/commit/f62ee6a88411ef47804893dcf153adcd9122bbc0)), closes [#2434](https://github.com/Superoldman96/vscode-neovim/issues/2434)
* prevent loop on OptionSet ([#2282](https://github.com/Superoldman96/vscode-neovim/issues/2282)) ([5437cd6](https://github.com/Superoldman96/vscode-neovim/commit/5437cd6412af1000270afffc33b01b827e97618d))
* pulling status causes a redraw ([#2032](https://github.com/Superoldman96/vscode-neovim/issues/2032)) ([fbc7c0d](https://github.com/Superoldman96/vscode-neovim/commit/fbc7c0dc4c3a21ac3c801f800844b3673a32abbd))
* queue text document change events ([#2183](https://github.com/Superoldman96/vscode-neovim/issues/2183)) ([8944a06](https://github.com/Superoldman96/vscode-neovim/commit/8944a066e66b544da359ad1bb0781bb663a7c53a))
* rapid cmdline_show/cmdline_hides would not be handled logically ([#2140](https://github.com/Superoldman96/vscode-neovim/issues/2140)) ([7d65a19](https://github.com/Superoldman96/vscode-neovim/commit/7d65a19d63cf3ff8453d7ab20e2299037a320b4b))
* redraw events are processed in order ([#1940](https://github.com/Superoldman96/vscode-neovim/issues/1940)) ([122eb56](https://github.com/Superoldman96/vscode-neovim/commit/122eb56c9bd00570ea58b1da778fddb670437ae9))
* reduce text jumpiness when using the substitute command ([#1973](https://github.com/Superoldman96/vscode-neovim/issues/1973)) ([d6e44dd](https://github.com/Superoldman96/vscode-neovim/commit/d6e44dda9d46463879ae5733ee157dbae3c90a23))
* refactor buffer manager ([#1666](https://github.com/Superoldman96/vscode-neovim/issues/1666)) ([1a27694](https://github.com/Superoldman96/vscode-neovim/commit/1a2769478cb10483c449421e6ddb202bcf2c5472))
* remove maximum debounce time for normal selection ([#2082](https://github.com/Superoldman96/vscode-neovim/issues/2082)) ([2bd5166](https://github.com/Superoldman96/vscode-neovim/commit/2bd5166970421795b8ca5af2f55813167c6862e7))
* remove redundant error message on disconnect ([#2026](https://github.com/Superoldman96/vscode-neovim/issues/2026)) ([95171d2](https://github.com/Superoldman96/vscode-neovim/commit/95171d2aa7e5427e200f4fe214cd0e510c1a2dbb))
* replace execSync with spawnSync ([#2376](https://github.com/Superoldman96/vscode-neovim/issues/2376)) ([f245bf7](https://github.com/Superoldman96/vscode-neovim/commit/f245bf7c75a0a7e26d45f3eab9ce2c3df402630e))
* rework `:tabnew` ([#1601](https://github.com/Superoldman96/vscode-neovim/issues/1601)) ([1bff688](https://github.com/Superoldman96/vscode-neovim/commit/1bff688386c6ec9e7aa48e8544fd66dd4b37e14b))
* rework visual-multi ([#1755](https://github.com/Superoldman96/vscode-neovim/issues/1755)) ([0bd6834](https://github.com/Superoldman96/vscode-neovim/commit/0bd68345fae514572c62927a81071af68963f78e))
* set an explicit id for status bar item ([#1941](https://github.com/Superoldman96/vscode-neovim/issues/1941)) ([8c1f5a0](https://github.com/Superoldman96/vscode-neovim/commit/8c1f5a093e13cf80638478f479c63807122d8bfd))
* set correct cwd for WSL ([#1689](https://github.com/Superoldman96/vscode-neovim/issues/1689)) ([240e8f9](https://github.com/Superoldman96/vscode-neovim/commit/240e8f9d0b4b14224242d86c3487cc6bd8a22fa0))
* set current dir in nvim ([#2078](https://github.com/Superoldman96/vscode-neovim/issues/2078)) ([01aadaa](https://github.com/Superoldman96/vscode-neovim/commit/01aadaa9f3074b0622d20daefc694b4933f3a8d7))
* set highlight group Subsitute ([#1983](https://github.com/Superoldman96/vscode-neovim/issues/1983)) ([479638f](https://github.com/Superoldman96/vscode-neovim/commit/479638fb0bac36d1d9f003e593f6ab43ca0d59b9))
* setup highlights timely ([#1964](https://github.com/Superoldman96/vscode-neovim/issues/1964)) ([6c220c7](https://github.com/Superoldman96/vscode-neovim/commit/6c220c7dc3f036529492a1fef197a790a24c2077))
* should setup highlights on WinNew,BufNew ([#1944](https://github.com/Superoldman96/vscode-neovim/issues/1944)) ([178483c](https://github.com/Superoldman96/vscode-neovim/commit/178483c4d6a7812976ffb0e7b88f84b25a425fed))
* skip window changed when target window id is 1000 ([#1667](https://github.com/Superoldman96/vscode-neovim/issues/1667)) ([56ca01f](https://github.com/Superoldman96/vscode-neovim/commit/56ca01f803056c79c04a0522b67637b6484706a0))
* sometimes eol highlight being displayed incorrectly ([#1988](https://github.com/Superoldman96/vscode-neovim/issues/1988)) ([9e208f2](https://github.com/Superoldman96/vscode-neovim/commit/9e208f24f50137e6899bb4c6743e09cc4adedc9d))
* **startup:** $VIMRUNTIME check fails on WSL [#1850](https://github.com/Superoldman96/vscode-neovim/issues/1850) ([6db15d0](https://github.com/Superoldman96/vscode-neovim/commit/6db15d02a1547e53a9373680a52fa6160346a1e7)), closes [#1848](https://github.com/Superoldman96/vscode-neovim/issues/1848)
* **startup:** null reference in onDidChangeWindowState handler [#2290](https://github.com/Superoldman96/vscode-neovim/issues/2290) ([c3e8387](https://github.com/Superoldman96/vscode-neovim/commit/c3e8387a9e9f923ec39c28af6cb8985ca431e438))
* **startup:** unclear "minimum version" message for nvim prerelease ([#2229](https://github.com/Superoldman96/vscode-neovim/issues/2229)) ([88cf605](https://github.com/Superoldman96/vscode-neovim/commit/88cf6059f5fc327af14e1930dfe3c31b213e97c3))
* tabstops now considered when calculating line width for highlights ([#1897](https://github.com/Superoldman96/vscode-neovim/issues/1897)) ([bd4cbca](https://github.com/Superoldman96/vscode-neovim/commit/bd4cbca3dac2bca45ecb32fd32a6eff8895de093))
* **test:** normalize EOL ([#2402](https://github.com/Superoldman96/vscode-neovim/issues/2402)) ([c095de7](https://github.com/Superoldman96/vscode-neovim/commit/c095de724ed0aeb3d94f9bc8552fffedc4dbecff))
* **test:** upgrade @vscode/test-electron ([#1690](https://github.com/Superoldman96/vscode-neovim/issues/1690)) ([d3b25fd](https://github.com/Superoldman96/vscode-neovim/commit/d3b25fd9b186a817a5232a6a524e0deeb238b6cf))
* **test:** use custom `clipboardCopyAction` implementation ([#2414](https://github.com/Superoldman96/vscode-neovim/issues/2414)) ([4a7675f](https://github.com/Superoldman96/vscode-neovim/commit/4a7675fe6ed45478d8e6745fefd04717ab1afd48))
* treat all auto-generated documents as external ([#2418](https://github.com/Superoldman96/vscode-neovim/issues/2418)) ([9754628](https://github.com/Superoldman96/vscode-neovim/commit/9754628e9baff55f62cf4a9bb15cf239ae9cceee))
* treesitter language injections ([#2356](https://github.com/Superoldman96/vscode-neovim/issues/2356)) ([4077b73](https://github.com/Superoldman96/vscode-neovim/commit/4077b73eaf4e0eb7f302f38a3d5b93f7d15c7933))
* **treesitter:** manually trigger parsing ([#1713](https://github.com/Superoldman96/vscode-neovim/issues/1713)) ([c2ca1be](https://github.com/Superoldman96/vscode-neovim/commit/c2ca1be787c9114bdb7dcc57e47d1932cd9fb878))
* update expected cursor when multiple docs change ([#2035](https://github.com/Superoldman96/vscode-neovim/issues/2035)) ([504da9e](https://github.com/Superoldman96/vscode-neovim/commit/504da9eb1516c7890cf00d50b6916fd4c6578008))
* update link to #performance docs from vscode affinity prompt ([#2254](https://github.com/Superoldman96/vscode-neovim/issues/2254)) ([6505e54](https://github.com/Superoldman96/vscode-neovim/commit/6505e542ae31cd12baba8624de88740f86978b2d))
* use the cursor style from VS Code as the style for insert mode ([#2455](https://github.com/Superoldman96/vscode-neovim/issues/2455)) ([2a632e0](https://github.com/Superoldman96/vscode-neovim/commit/2a632e0ee0f2576ec3569f02c219a5ddbe18ff6b))
* **viewport:** Avoid awaiting the hack to refresh viewport ([d5cb701](https://github.com/Superoldman96/vscode-neovim/commit/d5cb701f845f90e9ca7b9d9943515b94c7211390))
* **visual:** clear fake cursor correctly ([#1552](https://github.com/Superoldman96/vscode-neovim/issues/1552)) ([c786074](https://github.com/Superoldman96/vscode-neovim/commit/c786074df01bc02d52856620d0da2db60659ae1a))
* **visual:** Fix syncing vscode selection to nvim ([#1647](https://github.com/Superoldman96/vscode-neovim/issues/1647)) ([8d2a14a](https://github.com/Superoldman96/vscode-neovim/commit/8d2a14a9171fd5cd25672fc68479333335a5f655))
* **visual:** optimized simulation of VisualChanged event ([#1597](https://github.com/Superoldman96/vscode-neovim/issues/1597)) ([736e7b2](https://github.com/Superoldman96/vscode-neovim/commit/736e7b261eeecacb163e0fc1b59a0a1dd4f1bbf8))
* **visual:** process selections in nvim ([#1603](https://github.com/Superoldman96/vscode-neovim/issues/1603)) ([c202f52](https://github.com/Superoldman96/vscode-neovim/commit/c202f527949d3af2f786b2a0cab71b96517d4657))
* **visual:** wrong selections on nvim 0.13 [#2636](https://github.com/Superoldman96/vscode-neovim/issues/2636) ([a8edd84](https://github.com/Superoldman96/vscode-neovim/commit/a8edd845e4ca6c332a8a600d25867ee83a9b11e7))
* vscode null in eval ([#1866](https://github.com/Superoldman96/vscode-neovim/issues/1866)) ([923319a](https://github.com/Superoldman96/vscode-neovim/commit/923319af2e2b41bd5e64f46dbf1fdac6262b170f))
* wait for appling selection changed ([#1551](https://github.com/Superoldman96/vscode-neovim/issues/1551)) ([e1e1bf0](https://github.com/Superoldman96/vscode-neovim/commit/e1e1bf01354495b3cf7a8731e2ec8729886532c6))
* we need to execute treesitter parsing manually ([#2400](https://github.com/Superoldman96/vscode-neovim/issues/2400)) ([81f5202](https://github.com/Superoldman96/vscode-neovim/commit/81f5202cff7146f22c48a5a07adcf230a82bfc96))
* wildmenu items are being set repeatedly ([#1989](https://github.com/Superoldman96/vscode-neovim/issues/1989)) ([fc48f03](https://github.com/Superoldman96/vscode-neovim/commit/fc48f03d405f4a3a0e77d9ed4ead7efa8292f05e))
* wildmenu sometimes not showing ([c01e149](https://github.com/Superoldman96/vscode-neovim/commit/c01e1496e1ec5a46872297cabb3ed0a46ecc6f1c))
* **windows:** backslashes in path settings [#2286](https://github.com/Superoldman96/vscode-neovim/issues/2286) ([48ab180](https://github.com/Superoldman96/vscode-neovim/commit/48ab180ca2cd751d8088496e518099ecdfc95f09))
* **window:** stale window-changed event steals focus back [#2666](https://github.com/Superoldman96/vscode-neovim/issues/2666) ([9c86f0e](https://github.com/Superoldman96/vscode-neovim/commit/9c86f0e777806d5d1a456f11b169c288bba5ef71))
* **with_insert:** Correct "a" or "i" to enter insert mode ([#2152](https://github.com/Superoldman96/vscode-neovim/issues/2152)) ([dfa195b](https://github.com/Superoldman96/vscode-neovim/commit/dfa195bfb1b1d2129294738bf3479efe6a6db5b9))


### Refactor

* `pending_updates` -&gt; `/utils` `cmdline_text` -&gt; `/cmdline` ([#2159](https://github.com/Superoldman96/vscode-neovim/issues/2159)) ([cf62ea4](https://github.com/Superoldman96/vscode-neovim/commit/cf62ea42c12cecae31c1be931f46312d4734219f))
* Add "actions.lua" for executing internal lua functions ([#1605](https://github.com/Superoldman96/vscode-neovim/issues/1605)) ([5f442aa](https://github.com/Superoldman96/vscode-neovim/commit/5f442aaa702bdd8897795c6b84efa2ec71ef5751))
* **api:** call Lua API within vim functions ([#1604](https://github.com/Superoldman96/vscode-neovim/issues/1604)) ([efd9470](https://github.com/Superoldman96/vscode-neovim/commit/efd94703615d685c16336cd7323eaa277a3e093d))
* check required version in nvim ([#1678](https://github.com/Superoldman96/vscode-neovim/issues/1678)) ([f875e23](https://github.com/Superoldman96/vscode-neovim/commit/f875e23190fa7a7187d7c1148838795e37cf30e8))
* clean up deprecated content ([#2012](https://github.com/Superoldman96/vscode-neovim/issues/2012)) ([940cd4a](https://github.com/Superoldman96/vscode-neovim/commit/940cd4a65cbc10a562aad790c4a4ab204540e914))
* **config:** use `vscode-neovim.restart` for restarting ([21e9da5](https://github.com/Superoldman96/vscode-neovim/commit/21e9da53f073538d838dd97bcb421903f7824a94))
* **document_change:** simplify nvim to vscode change sync ([#1571](https://github.com/Superoldman96/vscode-neovim/issues/1571)) (f10cb1a0) ([0510daf](https://github.com/Superoldman96/vscode-neovim/commit/0510daf1389cc21b6a6d3b0768695d11b65a0cb0))
* don't hardcode substitute highlight ([#1991](https://github.com/Superoldman96/vscode-neovim/issues/1991)) ([1b6bb7b](https://github.com/Superoldman96/vscode-neovim/commit/1b6bb7b917ce31594826fea541547effc4622e7d))
* enable vscode-neovim.lua to accept an array of strings ([#1930](https://github.com/Superoldman96/vscode-neovim/issues/1930)) ([8becac6](https://github.com/Superoldman96/vscode-neovim/commit/8becac679ffed5ccfc86191d373c076d3abb2430))
* extract highlight provider grid logic into its own data structure ([#1901](https://github.com/Superoldman96/vscode-neovim/issues/1901)) ([6d054de](https://github.com/Superoldman96/vscode-neovim/commit/6d054de078b21e73f24ee45d57c6327dd39ae3cf))
* follow nvim ui-messages protocol ([#2177](https://github.com/Superoldman96/vscode-neovim/issues/2177)) ([bc42292](https://github.com/Superoldman96/vscode-neovim/commit/bc422929ca0314aafe98653ce2b7d88f4e643b0a))
* Improve explanation of Ctrl+key in settings menu ([#2168](https://github.com/Superoldman96/vscode-neovim/issues/2168)) ([f305226](https://github.com/Superoldman96/vscode-neovim/commit/f305226eb33dcdb8de5ac7eba6376ff7d72c138e))
* Improve usability of afterInitConfig option in the settings ([#2167](https://github.com/Superoldman96/vscode-neovim/issues/2167)) ([fe586e1](https://github.com/Superoldman96/vscode-neovim/commit/fe586e1a62f618be3ae434dd9076e8ef1acca5c5))
* init output channels in the corresponding manager ([#2053](https://github.com/Superoldman96/vscode-neovim/issues/2053)) ([927ed95](https://github.com/Superoldman96/vscode-neovim/commit/927ed955d9075f40bb5f2f40d2ad9e057f13906c))
* **lua:** move autocmds,filetype to runtime/modules ([#1990](https://github.com/Superoldman96/vscode-neovim/issues/1990)) ([c81e64d](https://github.com/Superoldman96/vscode-neovim/commit/c81e64dd0f0502f79b14fe2430d7d442f347fd85))
* **lua:** rename the module vscode-neovim to vscode ([#1997](https://github.com/Superoldman96/vscode-neovim/issues/1997)) ([109e125](https://github.com/Superoldman96/vscode-neovim/commit/109e125210e4c2936e1775735e887a020fdd336a))
* **messages:** merge statusline into MessagesManager [#2645](https://github.com/Superoldman96/vscode-neovim/issues/2645) ([bed95d0](https://github.com/Superoldman96/vscode-neovim/commit/bed95d09228848017718be480fdc1acdd34ae365))
* move "vim/" and merge it into "runtime/" ([#2017](https://github.com/Superoldman96/vscode-neovim/issues/2017)) ([3a5ecb2](https://github.com/Superoldman96/vscode-neovim/commit/3a5ecb26086ca9f4add610e8d6844e1762e9d122))
* register type commands only when needed ([#1931](https://github.com/Superoldman96/vscode-neovim/issues/1931)) ([f25b899](https://github.com/Superoldman96/vscode-neovim/commit/f25b8991993992987817a7a82185d63be3d1d2a1))
* Remove debounce time limit for sync mouse selection ([#2153](https://github.com/Superoldman96/vscode-neovim/issues/2153)) ([af78dc9](https://github.com/Superoldman96/vscode-neovim/commit/af78dc9cbebd0177b2178f93cfbf6dbc0e3adf6e))
* remove the border of the custom highlights ([479638f](https://github.com/Superoldman96/vscode-neovim/commit/479638fb0bac36d1d9f003e593f6ab43ca0d59b9))
* remove use of nvim_call_atomic [#1904](https://github.com/Superoldman96/vscode-neovim/issues/1904) ([a63a34c](https://github.com/Superoldman96/vscode-neovim/commit/a63a34c90f3cb9e1bd35bcaa66e0eabc37df239b))
* remove viewport hack when in cmdline mode ([5fedba5](https://github.com/Superoldman96/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* set enforced options in Lua ([#2011](https://github.com/Superoldman96/vscode-neovim/issues/2011)) ([798792c](https://github.com/Superoldman96/vscode-neovim/commit/798792c0b2c0c6e5ff1507b73fd5731f6bb6d31d))
* simplify highlight range building logic ([#1915](https://github.com/Superoldman96/vscode-neovim/issues/1915)) ([f2d1a1d](https://github.com/Superoldman96/vscode-neovim/commit/f2d1a1d3a7a8e1da610877b2cffbdbec988437d2))
* Simplify invoking Treesitter parsing and ensure more timely parsing ([#2154](https://github.com/Superoldman96/vscode-neovim/issues/2154)) ([be2ae6b](https://github.com/Superoldman96/vscode-neovim/commit/be2ae6b2e68382c7823abb777e7bbb13049d6fb8))
* source "afterInitConfig" using nvim_exec2 ([#1705](https://github.com/Superoldman96/vscode-neovim/issues/1705)) ([0aa3152](https://github.com/Superoldman96/vscode-neovim/commit/0aa315261cf11c6561326a95f3d12a5d74499b1c))
* **timeutil:** rename waitForCondition =&gt; waitUntil [#2667](https://github.com/Superoldman96/vscode-neovim/issues/2667) ([bdce612](https://github.com/Superoldman96/vscode-neovim/commit/bdce61226868b8ac1b3ee5de5edbf26ec039ddbe))
* use action for builtin multi-cursor feature ([f4a6ac5](https://github.com/Superoldman96/vscode-neovim/commit/f4a6ac5bc2fd942a76402f27e3bb88df2924bba4))
* use builtin packageJson instead reading it manually ([550d53c](https://github.com/Superoldman96/vscode-neovim/commit/550d53cc08b1551542ed00dafe68001b49e797d9))
* Use labeled tuple elements for event data types ([#2129](https://github.com/Superoldman96/vscode-neovim/issues/2129)) ([08e973d](https://github.com/Superoldman96/vscode-neovim/commit/08e973d20e93835416c3c5a7bd3a81239c02d213))


### Performance Improvements

* Add VSCodeContext for perf improvement ([#1559](https://github.com/Superoldman96/vscode-neovim/issues/1559)) ([62fbcc2](https://github.com/Superoldman96/vscode-neovim/commit/62fbcc26fec546dbdef603ea7c1065ce1d511885))
* avoid unnecessary sending of editor options to neovim ([#2419](https://github.com/Superoldman96/vscode-neovim/issues/2419)) ([041e540](https://github.com/Superoldman96/vscode-neovim/commit/041e540ab30e9dd6474292755ef2152ff8018d01))
